...
namespace Pipe::os_services::fs
{
	...
	enum class file_access_permission_bit
	{
		other_execute = 0,
		other_write   = 1,
		other_read    = 2,
	...
	constexpr file_access_permission_bit mkae_file_access_permission_bit(std::string_view str)
	{
	...
	enum class file_access_permission
	{
		other_execute = 1<<static_cast<int>(file_access_permission_bit::other_execute),
		other_write   = 1<<static_cast<int>(file_access_permission_bit::other_write  ),
		other_read    = 1<<static_cast<int>(file_access_permission_bit::other_read   ),
		group_execute = 1<<static_cast<int>(file_access_permission_bit::group_execute),
		group_write   = 1<<static_cast<int>(file_access_permission_bit::group_write  ),
		group_read    = 1<<static_cast<int>(file_access_permission_bit::group_read   ),
		owner_execute = 1<<static_cast<int>(file_access_permission_bit::owner_execute),
		owner_write   = 1<<static_cast<int>(file_access_permission_bit::owner_write  ),
		owner_read    = 1<<static_cast<int>(file_access_permission_bit::owner_read   )
	};
